...
* [The parallel distributed processing approach to semantic cognition](https://github.com/knathanieltucker/deeplearning-papernotes/blob/master/notes/parallel_distributed_processing_approach_to_semantic_cognition.md) [[Nature](http://www.nature.com/nrn/journal/v4/n4/abs/nrn1076.html)]
* [Unsupervised Learning of Invariant Feature Hierarchies with Applications to Object Recognition](https://github.com/knathanieltucker/deeplearning-papernotes/blob/master/notes/unsupervised_learning_of_invariant_feature_hierarchies_with_applications_to_object_recognition.md) [[LeCun](http://yann.lecun.com/exdb/publis/pdf/ranzato-cvpr-07.pdf)]
* [API design for machine learning software: experiences from the scikit-learn project](https://github.com/knathanieltucker/deeplearning-papernotes/blob/master/notes/api_design_for_machine_learning_software.md) [[arXiv](https://arxiv.org/pdf/1309.0238.pdf)]
* [Image-based object recognition in man, monkey and machine](https://github.com/knathanieltucker/deeplearning-papernotes/blob/master/notes/Image_based_object_recognition_in_man_monkey_and_machine.md) [[Science](http://www.sciencedirect.com/science/article/pii/S0010027798000262)]
...
* [Hierarchical Bayesian inference in the visual cortex](https://github.com/knathanieltucker/deeplearning-papernotes/blob/master/notes/hierarchical_bayesian_inference_in_the_visual_cortex.md) [[CMU](http://www.cnbc.cmu.edu/~tai/papers/lee_mumford_josa.pdf)]
